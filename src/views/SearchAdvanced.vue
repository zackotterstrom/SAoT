<template lang="pug">
  .container
    b-jumbotron(bg-variant="light" text-variant="dark" header="Advanced search for tweets")
        form.t1-form.twitter-form(role="searchPanel")
          b-btn.m-1(v-b-toggle.words) Words
          b-btn.m-1(v-b-toggle.people) People
          b-btn.m-1(v-b-toggle.other) Other
          b-btn.float-right(variant="success" :disabled="query.length == 0" @click="search") Search
            font-awesome-icon.ml-1(icon="search")
          b-collapse#words(accordion="search-accordion" role="searchPanel" visible)
            b-card
              b-container
                b-row
                  b-col(cols="3")
                  ...
                  b-col(cols="9")
                    input.w-100(name='ands' type='text' v-model="all_words")
                b-row
                  b-col(cols="3")
                    label This exact phrase:
                  b-col(cols="9")
                    input.w-100(name='phrase' type='text' v-model="exact_words")
                b-row
                  b-col(cols="3")
                    label Any of these words:
                  b-col(cols="9")
                    input.w-100(name='ors' type='text' v-model="any_words")
                b-row
                  b-col(cols="3")
                    label None of these words:
                  b-col(cols="9")
                    input.w-100(name='nots' type='text' v-model="none_words")
                b-row
                  b-col(cols="3")
                    label These hashtags:
                  b-col(cols="9")
                    input.w-100(name='tag' type='text' v-model="hashtags")
                b-row
                  b-col(cols="3")
                    label Written in:
                  b-col(cols="9")
                    select.w-100(name='lang' v-model="lang")
          ...
          b-collapse#people(accordion="search-accordion" role="searchPanel")
            b-card
              b-container
                b-row
                  b-col(cols="3")
                  ...
                  b-col(cols="9")
                    input.w-100(name='from' type='text' v-model="from")
                b-row
                  b-col(cols="3")
                    label To these accounts:
                  b-col(cols="9")
                    input.w-100(name='to' type='text' v-model="to")
                b-row
                  b-col(cols="3")
                    label Mentioning these accounts:
                  b-col(cols="9")
                    input.w-100(name='ref' type='text' v-model="mention")
          b-collapse#other(accordion="search-accordion" role="searchPanel")
            b-card
              b-container
                b-row
                  b-col(cols="3")
                    label Tweet count:
                  b-col(cols="9")
                    input.w-100(type="number" min="1" max="100" v-model="count")
                b-row
                  b-col(cols="3")
                    label  Result type:
                  b-col(cols="9")
                    select.w-100(name='result_type' v-model="result_type")
